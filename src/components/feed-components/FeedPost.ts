          ...
          <div class="footer">  
            ...
            <div class="align-comments">
              <button class="just-comments">
                ...
                <p class="comments-count">${this.post.comments && this.post.comments.length > 0 ? this.post.comments.length + ' Comments' : 'Be the first to share something interesting'}</p>
              </button>
            </div>
