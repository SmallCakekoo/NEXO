class TeacherDetailCard extends HTMLElement {
    ...
    render() {
        ...
        const stars = Array(5)
            .fill(0)
            .map((_, i) => `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" class="${i < rating ? "filled" : ""}" fill="${i < rating ? "#5354ED" : "#e0e0fe"}" stroke="none" class="star-icon">
...
//# sourceMappingURL=TeacherDetailCard.js.map