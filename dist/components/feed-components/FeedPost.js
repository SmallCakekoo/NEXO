export var FeedPostAttributes;
(function (FeedPostAttributes) {
    FeedPostAttributes["photo"] = "photo";
    FeedPostAttributes["name"] = "name";
    FeedPostAttributes["date"] = "date";
    FeedPostAttributes["career"] = "career";
    FeedPostAttributes["semestre"] = "semestre";
    FeedPostAttributes["message"] = "message";
    FeedPostAttributes["tag"] = "tag";
    FeedPostAttributes["likes"] = "likes";
    FeedPostAttributes["share"] = "share";
    FeedPostAttributes["comments"] = "comments";
})(FeedPostAttributes || (FeedPostAttributes = {}));
